 ...
 * 
 * Most of this code and a good number of the comments, apart from where the program 
 * tests whether the file is indeed a bitmap, is taken from Dr. Nelson's DibDump.java code. 
 * 
